import type { RawStandardsFinding } from '@/contracts';
 ...
 * keeping the others.
 */
export const buildUnconsumedFindings = ({ files, contents, rule, matches, detail, guidance }: Params): RawStandardsFinding[] => {
	const byFile = new Map<string, string[]>();

	for (const { file, name, reachedBy } of getUnconsumedExports({ files, contents })) {
