export { buildStandardsDocuments } from '#src/standardsPacks/buildStandardsDocuments.ts';
export type { LoadedStandardsDocument } from '#src/standardsPacks/common/types/LoadedStandardsDocument.ts';
export type { LoadedStandardsPack } from '#src/standardsPacks/common/types/LoadedStandardsPack.ts';
