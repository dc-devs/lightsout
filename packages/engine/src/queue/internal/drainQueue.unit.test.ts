...
type SettleMergedTreesParams = Parameters<typeof import('#src/queue/internal/common/utils/settleMergedTrees.ts').settleMergedTrees>[0];
...
jest.mock('#src/queue/internal/common/utils/settleMergedTrees.ts', () => ({
