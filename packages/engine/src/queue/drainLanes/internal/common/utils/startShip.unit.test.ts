...
import type { shipOneBranch } from '#src/queue/internal/shipOneBranch.ts';
...
jest.mock('#src/queue/internal/shipOneBranch.ts', () => ({ shipOneBranch: (params: Parameters<typeof shipOneBranch>[0]) => mockShip(params) }));
